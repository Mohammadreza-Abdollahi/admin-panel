...
const Product = () => {
  ...
  return (
    <>
      ...
      <section>
        <PaginationTable data={data} dataInfo={dataInfo} actionCol={actionsColumn} rowInPage={10} searchable={true} dialogOpenner={productOpenClose} searchParam={{title: 'title' , placeholder: "دسته بندی مورد نظر را جستجو کنید..."}}/>
      </section>
    </>
  );
};
