...
import { createCategoryService, getCategoriesService, getCategoryByIdService, updateCategoryService } from "../../services/categoryServices";
...
const onSubmit = async (values , actions , setForceRender , dispatch , editId)=>{
  try{
    values = {
      ...values,
