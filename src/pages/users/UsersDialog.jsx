            ...
            <FullScreenDialog dialogTitle={'ویرایش سبد'} open={isOpen} myDispatch={cartsOpenClose}>
                <section dir="rtl" className="w-full mx-auto py-5 overflow-y-auto px-10">
                    ...
                    <section className="w-2/3 m-auto mt-14">
                        <CartItem title1={'محصول شماره یک'} title2={'100 هزار تومان'} title3={'گارانتی اواژنگ'} count={5} color={'red'}/>
                        <CartItem title1={'محصول شماره یک'} title2={'100 هزار تومان'} title3={'گارانتی اواژنگ'} count={5} color={'blue'}/>
                        <CartItem title1={'محصول شماره یک'} title2={'100 هزار تومان'} title3={'گارانتی اواژنگ'} count={5} color={'greennpm'}/>
                    </section>
